...
if ( ! class_exists( 'FM_Bylines' ) ) {
	...
	class FM_Bylines {
		...
		public function add_meta_boxes() {
			...
			$fm_names = new Fieldmanager_Group(
				array(
			...
			$fm_contact_info = new Fieldmanager_Group(
				array(
			...
			$fm_about = new Fieldmanager_Group(
				array(
			...
			// User Mapping.
			$fm_user_mapping = new Fieldmanager_Autocomplete(
				array(
		...
		public function add_byline_meta_box( $type = 'author', $label = null, $args = array() ) {
			...
			if ( is_admin() ) {
				...
				$defaults        = array(
					...
					'children'       => array(
						'byline_id'      => new Fieldmanager_Autocomplete(
							array(
								'default_value' => null,
